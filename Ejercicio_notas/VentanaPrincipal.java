...
public class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    private JLabel nota1, nota2, nota3, nota4, nota5,
            promedio, desviacion, mayor, menor;
...
public VentanaPrincipal(){
    inicio();
    setTitle("Notas estudiante");
    setSize(280,380);
    setLocationRelativeTo(null); /* Ventana en el centro
    de la pantalla */
    setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    /* El botón de cerrar permite salir de la app */
    setResizable(false);
    /* Tamaño ventana no se puede cambiar */
}

private void inicio(){
    contenedor = getContentPane();
    /* Panel de contenidos de la ventana */
    contenedor.setLayout(null);
    /* Contenedor sin un layout */
    ...
    /* Action listener para el botón para que gestione
    eventos */
    promedio = new JLabel();
    ...
    /*Añadir cada componente gráfico al contenedor
    */
...
/*Eventos generados de la ventana principal */
@Override
public void actionPerformed(ActionEvent evento){
    if (evento.getSource() == calcular){
        Ejerc_notas notas = new Ejerc_notas();
